...
public class Connection {
    ...
    private void initClient(MqttAndroidClient client) {
        ...
        addConnectionOptions(mqttConnectOptions);
    ...
    public void connect() {
        ...
        final ActionListener callback = new ActionListener(context,
                ActionListener.Action.CONNECT, this, actionArgs);
        getClient().setCallback(new MqttCallbackHandler(context, handle()));
        try {
            getClient().connect(getConnectionOptions(), null, callback);
...
//    }
    ...
    public void setSubscription(Subscription newSubs) {
        subscriptions.put(newSubs.getTopic(), newSubs);
        //connect();
    }
